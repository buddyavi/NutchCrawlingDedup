 ...
 * </p>
 */
public class UrlFilterDuplicates implements URLFilter {

 private static final Logger LOG = LoggerFactory
      .getLogger(UrlFilterDuplicates.class);
//
...
//
 public UrlFilterDuplicates() throws IOException {

 }
//
//  public UrlFilterDuplicates(String stringRules) throws IOException {
//    trie = readConfiguration(new StringReader(stringRules));
//  }

  public String filter(String url) {
    LOG.info("*********DUPLICATE PLUGIN WORKING*************");
    return url;
  }
...
//  }
  ...
  public static void main(String args[]) throws IOException {
	 ...
	 UrlFilterDuplicates filter = new UrlFilterDuplicates();
